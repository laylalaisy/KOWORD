...
from .views import LearnBookListView, LearnUnitListView, LearnWordListView, LearnWordView
...
urlpatterns = [
    ...
    url(r'^wordlearn/(?P<book_id>\d+)/(?P<word_unit>\d+)/(?P<user_id>\d+)$', LearnWordView.as_view(), name='learn_wordlearn'),
]
